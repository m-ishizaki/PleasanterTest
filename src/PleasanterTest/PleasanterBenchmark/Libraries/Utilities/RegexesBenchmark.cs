...
namespace PleasanterBenchmark.Libraries.Utilities
{
    public class RegexesBenchmark
    {
        ...
        [TinyBenchmark] public static void TestRegexExists_NoMatch() => "Hello World".RegexExists("Universe");
        [TinyBenchmark] public static void TestRegexMatches_MatchFound() => "Hello World".RegexMatches("World");
        [TinyBenchmark] public static void TestRegexLike_MatchFound() => "Hello World".RegexLike("world");
        [TinyBenchmark] public static void TestRegexMatches_NoMatch() => "Hello World".RegexMatches("Universe");
